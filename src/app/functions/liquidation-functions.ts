...
export module LiquidationFn {
  /**
   * 仕入先関連で使用されるすべての選択肢項目のインターフェイス
   */
  export interface Options {
    display_division: SelectOption[]; // 表示区分
    liquidation_division: SelectOption[]; // 精算区分
  ...
  export function initOptions(
    divisionOptions: Record<string, SelectOption[]>,
    ...
    options.display_division = divisionOptions['精算項目表示区分'];
    options.liquidation_division = divisionOptions['精算項目支払区分'];
