...
import { InventoryFn } from 'src/app/functions/inventory-functions';
...
export interface InventoryForm extends FormGroup {
  controls: {
    inventory_code: FormControl;
    product_id: FormControl;
    inventory_quantity: FormControl;
    receiving_quantity: FormControl;
    inventory_date: FormControl;
    receiving_date: FormControl;
    inventory_rep_id: FormControl;
...
export class FormComponent {
  ...
  //  ///  )
  //  ///  .subscribe((res) => {
  //  ///    this.options.inventory_rep = res;
