...
@Component({
  selector: 'app-customer-order-reception-slip',
  templateUrl: './customer-order-reception-slip.component.html',
  styleUrls: ['./customer-order-reception-slip.component.scss'],
})
export class CustomerOrderReceptionSlipComponent implements OnInit, OnDestroy {
  /**
   * コンストラクタ
   * @param modalService
   * @param errorService
