...
import { Gift1AddComponent } from './gift1-add/gift1-add.component';
import { Gift1DetailComponent } from './gift1-detail/gift1-detail.component';
import { Gift1EditComponent } from './gift1-edit/gift1-edit.component';
import { Gift1ListComponent } from './gift1-list/gift1-list.component';

import { ToggleButtonModule } from '../toggle-button/toggle-button.module';
import { TableOrgModule } from 'src/app/components/organisms/gift1-org/table-org/table-org.module';
import { SearchOrgModule } from 'src/app/components/organisms/gift1-org/search-org/search-org.module';
