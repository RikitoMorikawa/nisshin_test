...
@Component({
  selector: 'app-gift4-list',
  templateUrl: './gift4-list.component.html',
  styleUrls: ['./gift4-list.component.scss'],
})
export class Gift4ListComponent implements OnInit, OnDestroy {
  // 購読を一括して格納
