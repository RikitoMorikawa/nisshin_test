...
@Component({
  selector: 'app-gift2-list',
  templateUrl: './gift2-list.component.html',
  styleUrls: ['./gift2-list.component.scss'],
})
export class Gift2ListComponent implements OnInit, OnDestroy {
  // 購読を一括して保持
