...
@Component({
  selector: 'app-custom-medium-category',
  templateUrl: './custom-medium-category.component.html',
  styleUrls: ['./custom-medium-category.component.scss'],
})
export class CustomMediumCategoryComponent implements OnInit, OnDestroy {
  constructor(
