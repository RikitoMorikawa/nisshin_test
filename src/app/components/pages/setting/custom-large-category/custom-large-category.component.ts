...
@Component({
  selector: 'app-custom-large-category',
  templateUrl: './custom-large-category.component.html',
  styleUrls: ['./custom-large-category.component.scss'],
})
export class CustomLargeCategoryComponent implements OnInit, OnDestroy {
  constructor(
