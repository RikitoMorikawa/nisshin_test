...
import { CustomSmallCategoryRoutingModule } from './custom-small-category-routing.module';
...
import { TableOrgModule } from 'src/app/components/organisms/custom-small-category-org/table-org/table-org.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    CustomSmallCategoryRoutingModule,
    ReactiveFormsModule,
    BreadcrumbOrgModule,
    SearchOrgModule,
    TableOrgModule,
...
export class CustomSmallCategoryModule {}
