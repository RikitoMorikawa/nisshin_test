...
@Component({
  selector: 'app-custom-small-category',
  templateUrl: './custom-small-category.component.html',
  styleUrls: ['./custom-small-category.component.scss'],
})
export class CustomSmallCategoryComponent implements OnInit, OnDestroy {
  constructor(
