...
@Component({
  selector: 'app-pb-first-category',
  templateUrl: './pb-first-category.component.html',
  styleUrls: ['./pb-first-category.component.scss'],
})
export class PbFirstCategoryComponent implements OnInit, OnDestroy {
  constructor(
