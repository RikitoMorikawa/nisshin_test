...
@Component({
  selector: 'app-pb-second-category',
  templateUrl: './pb-second-category.component.html',
  styleUrls: ['./pb-second-category.component.scss'],
})
export class PbSecondCategoryComponent implements OnInit, OnDestroy {
  constructor(
