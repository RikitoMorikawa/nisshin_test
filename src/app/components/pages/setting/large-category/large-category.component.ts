...
@Component({
  selector: 'app-large-category',
  templateUrl: './large-category.component.html',
  styleUrls: ['./large-category.component.scss'],
})
export class LargeCategoryComponent implements OnInit, OnDestroy {
  constructor(
