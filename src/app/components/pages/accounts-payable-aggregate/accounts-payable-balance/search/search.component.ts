...
import { AccountsPayableBalanceApiResponse } from 'src/app/models/accounts-payable-balance';
...
export class SearchComponent implements OnInit {
  ...
  // エラーモーダルのタイトル
  errorLoadTitle = '買掛残一覧画面エラー：' + modalConst.TITLE.HAS_ERROR;
  ...
  constructor(
    ...
    private accountsPayableBalanceService: AccountsPayableBalanceService
  ) {}
