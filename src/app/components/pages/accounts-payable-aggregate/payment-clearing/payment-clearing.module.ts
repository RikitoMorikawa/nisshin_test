...
import { PaymentClearingDetailModule } from './payment-clearing-detail/payment-clearing-detail.module';
import { PaymentClearingAddDetailModule } from './payment-clearing-add-detail/payment-clearing-detail.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    PaymentClearingDetailModule,
    PaymentClearingAddDetailModule,
    ReactiveFormsModule,
    FormPartsModule,
    CustomTagFormModule,
    IconContainerModule,
...
export class PaymentClearingModule {}
