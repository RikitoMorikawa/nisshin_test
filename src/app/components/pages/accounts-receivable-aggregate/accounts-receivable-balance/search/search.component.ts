...
import { AccountsReceivableBalanceApiResponse } from 'src/app/models/accounts-receivable-balance';
...
export class SearchComponent implements OnInit {
  ...
  // エラーモーダルのタイトル
  errorLoadTitle = '売掛残一覧画面エラー：' + modalConst.TITLE.HAS_ERROR;
  ...
  constructor(
    ...
    private accountsreceivablebalance: AccountsReceivableBalanceService
  ) {}
