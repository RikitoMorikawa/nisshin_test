...
import { DepositAddDetailComponent } from './deposit-detail.component';
...
@NgModule({
  declarations: [DepositAddDetailComponent, InputPairComponent],
  exports: [DepositAddDetailComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    TitleModule,
...
export class DepositAddDetailModule {}
