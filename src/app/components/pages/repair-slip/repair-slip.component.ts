...
@Component({
  selector: 'app-repair-slip',
  templateUrl: './repair-slip.component.html',
  styleUrls: ['./repair-slip.component.scss'],
})
export class RepairSlipComponent implements OnInit, OnDestroy {
  /**
   * コンストラクタ
   * @param modalService
   * @param errorService
