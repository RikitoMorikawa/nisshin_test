...
export interface Bill {
  ...
  accounts_receivable_aggregate_id: number;
  created_at: string;
  member_last_name: string;
  member_first_name: string;
  client_name_kana: string;
  sales_slip_tax_rate_8_tax_rate: number;
  sales_slip_tax_rate_8_tax_excluded_target_amount: number;
  sales_slip_tax_rate_8_tax_excluded_target_tax: number;
  sales_slip_tax_rate_8_tax_included_target_amount: number;
  sales_slip_tax_rate_8_tax_included_target_tax: number;
  sales_slip_tax_rate_10_tax_rate: number;
  sales_slip_tax_rate_10_tax_excluded_target_amount: number;
  sales_slip_tax_rate_10_tax_excluded_target_tax: number;
  sales_slip_tax_rate_10_tax_included_target_amount: number;
  sales_slip_tax_rate_10_tax_included_target_tax: number;
}
