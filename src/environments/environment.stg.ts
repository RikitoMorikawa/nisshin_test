...
export const protectedResources = {
  ...
  stockTransferApi: {
    endpoint: "https://dev-nisshin-stock-transfer.azurewebsites.net/api/stock-transfer",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  ...
  billingDataCreationApi: {
    endpoint: "https://dev-nisshin-accounts-receivable-aggregate.azurewebsites.net/api/billing-data-creation",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  billApi: {
    endpoint: "https://dev-nisshin-bill.azurewebsites.net/api/bill",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  billDetailApi: {
    endpoint: "https://dev-nisshin-bill-detail.azurewebsites.net/api/bill-detail",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  depositApi: {
    endpoint: "https://dev-nisshin-deposit.azurewebsites.net/api/deposit",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  depositDetailApi: {
    endpoint: "https://dev-nisshin-deposit-detail.azurewebsites.net/api/deposit-detail",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  accountsReceivableBalanceApi: {
    endpoint: "https://dev-nisshin-accounts-receivable-balance.azurewebsites.net/api/accounts-receivable-balance",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  paymentDataCreationApi: {
    endpoint: "https://dev-nisshin-accounts-payable-aggregate.azurewebsites.net/api/payment-data-creation",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  paymentApi: {
    endpoint: "https://dev-nisshin-payment.azurewebsites.net/api/payment",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  paymentDetailApi: {
    endpoint: "https://dev-nisshin-payment-detail.azurewebsites.net/api/payment-detail",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
  accountsPayableBalanceApi: {
    endpoint: "https://dev-nisshin-accounts-payable-balance.azurewebsites.net/api/accounts-payable-balance",
    scopes: [
      "https://devnisshin.onmicrosoft.com/f46baca3-2dce-4ba4-bec5-f7bb664bfb0f/Employee.All",
    ],
  },
